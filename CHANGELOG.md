...
* **tflint:** 🐛 bump Azure rules version, fix signature bug 41b3203

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 e88e7f2
* **deps:** update dependency opentofu to v1.12.2 f9daee0
* **deps:** update dependency opentofu to v1.12.3 2f83957
* **deps:** update dependency opentofu to v1.12.4 f9a04ab
* **deps:** update dependency tflint to v0.63.1 4f741b0
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 8ef4542
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 788a67d

## 8.0.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ bd79ac5

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 29bc573
* **deps:** update dependency opentofu to v1.11.7 f42f341
* **deps:** update dependency opentofu to v1.12.0 a1a7455
* **deps:** update dependency terraform-docs to v0.23.0 79e12fa
* **deps:** update dependency terraform-docs to v0.24.0 4e71089
* **deps:** update dependency tflint to v0.62.1 174e355
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 3df33ab
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 760401f
* **deps:** update tools c80283b
* **pre-commit:** 🔧 move to prek 8f7be0a
* **tfdocs:** bump tfdocs to v0.22 🔧 d216836

## 8.0.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 61a3762

### Code Refactoring

* update module structure and Github actions 👷 7445bdc

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing d63e298
* **deps:** 🔗 bump tflint rules version 5232350
* **deps:** 🔗 bump tflint rules version 7b5c6f2
* **deps:** update dependency trivy to v0.69.2 3adb3e9
* **deps:** update dependency trivy to v0.69.3 d323a62
* **deps:** update dependency trivy to v0.69.4 63fe78c
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 dcb2529

### Revert

* chore(deps): update dependency trivy to v0.69.4 🔒️ 23d6c8e

## 8.0.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 ff6aad7

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 63284c2
* **deps:** update dependency opentofu to v1.11.2 6f3a69a
* **deps:** update dependency opentofu to v1.11.3 a2ee4c1
* **deps:** update dependency opentofu to v1.11.4 0ec9000
* **deps:** update dependency opentofu to v1.11.5 bf10442
* **deps:** update dependency pre-commit to v4.4.0 a2ce39a
* **deps:** update dependency pre-commit to v4.5.0 2f7dcab
* **deps:** update dependency pre-commit to v4.5.1 33e5534
* **deps:** update dependency tflint to v0.60.0 6bd4c0f
* **deps:** update dependency tflint to v0.61.0 78a7a18
* **deps:** update dependency trivy to v0.67.1 79993eb
* **deps:** update dependency trivy to v0.67.2 643dd21
* **deps:** update dependency trivy to v0.68.1 dc6799e
* **deps:** update dependency trivy to v0.68.2 9d03745
* **deps:** update dependency trivy to v0.69.0 366dc1c
* **deps:** update dependency trivy to v0.69.1 191a04a
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 2233a3a
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 a5f33a1
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 ce67345
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 d9137e0
* **deps:** update tools a7ce21b

## 8.0.1 (2025-09-30)

### Code Refactoring

* **deps:** 🔗 update claranet/azurecaf to ~> 1.3.0 🔧 46f5bbb

### Miscellaneous Chores

* **⚙️:** ✏️ update template identifier for MR review 940c41f
* 🗑️ remove old commitlint configuration files 02225f4
* **deps:** 🔗 bump AzureRM provider version to v4.31+ 1042bc1
* **deps:** update dependency claranet/diagnostic-settings/azurerm to ~> 8.1.0 b34687e
* **deps:** update dependency opentofu to v1.10.0 806a756
* **deps:** update dependency opentofu to v1.10.1 287e052
* **deps:** update dependency opentofu to v1.10.3 a7fc466
* **deps:** update dependency opentofu to v1.10.6 f9b028e
* **deps:** update dependency opentofu to v1.8.8 7bdb3f4
* **deps:** update dependency opentofu to v1.9.0 3a2b325
* **deps:** update dependency opentofu to v1.9.1 396e59b
* **deps:** update dependency pre-commit to v4.1.0 e3955c4
* **deps:** update dependency pre-commit to v4.2.0 a93322e
* **deps:** update dependency terraform-docs to v0.20.0 8e95cf2
* **deps:** update dependency tflint to v0.55.0 778091a
* **deps:** update dependency tflint to v0.56.0 86bcfc5
* **deps:** update dependency tflint to v0.57.0 3609aca
* **deps:** update dependency tflint to v0.58.0 4e5a934
* **deps:** update dependency tflint to v0.58.1 de901cd
* **deps:** update dependency tflint to v0.59.1 74066b8
* **deps:** update dependency trivy to v0.58.1 a4449c7
* **deps:** update dependency trivy to v0.58.2 a296c10
* **deps:** update dependency trivy to v0.59.1 e719add
* **deps:** update dependency trivy to v0.60.0 3bdee79
* **deps:** update dependency trivy to v0.61.0 e0d1dfa
* **deps:** update dependency trivy to v0.61.1 971a503
* **deps:** update dependency trivy to v0.62.0 7775092
* **deps:** update dependency trivy to v0.62.1 4fe3250
* **deps:** update dependency trivy to v0.63.0 0dfce64
* **deps:** update dependency trivy to v0.66.0 c02f252
* **deps:** update dependency trivy to v0.67.0 8be93bc
* **deps:** update pre-commit hook alessandrojcm/commitlint-pre-commit-hook to v9.20.0 574c3a4
* **deps:** update pre-commit hook alessandrojcm/commitlint-pre-commit-hook to v9.21.0 c5d21f7
* **deps:** update pre-commit hook alessandrojcm/commitlint-pre-commit-hook to v9.22.0 69873e7
* **deps:** update pre-commit hook pre-commit/pre-commit-hooks to v6 ed0aee0
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.0 928f9d5
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.1 0186bff
* **deps:** update terraform claranet/diagnostic-settings/azurerm to ~> 8.2.0 393cb6d
* **deps:** update terraform claranet/subnet/azurerm to ~> 8.1.0 3f60e33
* **deps:** update tools 041b3c8
* **deps:** update tools c23f32a
* **deps:** update tools 58d0889
* **deps:** update tools ad92cfd
* update Github templates d3901bd
* update tflint config for v0.55.0 24eec27
